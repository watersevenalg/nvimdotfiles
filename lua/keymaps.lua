...
keymap.set('n', '<leader>=', '<c-w>=')
keymap.set('n', '<leader>m', ':CopilotChatOpen<CR>')
...
vim.keymap.set('n', "f", "<cmd>lua vim.lsp.buf.format{async=true}<CR>")
vim.keymap.set('n', 'e', ":wa!<CR>")
vim.keymap.set('n', '<S-e>', ':wqa!<CR>')
